...
<div>
	...
	<ol>
		...
		<li>Each gallery can display 25 or less album covers. Each cover will open an album with not more than 25
			images
		</li>
	...
	<ol>
		...
		<li>Description of each image from facebook will be used as image caption which is shown below the lightbox
			photo
		</li>
		...
		<tr>
			...
			<td>
				<input type="radio" name="loadlightbox"
					   value="mp"<?php if ($optvar['loadlightbox'] == 'mp') echo ' checked="checked"'; ?> />Built in
				Responsive Lightbox<br/>
				<input type="radio" name="loadlightbox"
					   value="no"<?php if ($optvar['loadlightbox'] == 'no') echo ' checked="checked"'; ?> />Other
				Lightbox
			</td>
		</tr>
		<tr>
	...
	<tr>
		<td>
			<ol>
				...
				<li>Install <a target="_blank" href="http://wordpress.org/extend/plugins/fancybox-for-wordpress/">FancyBox
						for Wordpress</a></li>
